...
?>
            ...
            <body>
                  ...
                  $imgDataEncoded = base64_encode($student['student_img']);
                  $imgDataEncoded = 'data:image/jpeg;base64,' . $imgDataEncoded;
                  ?>

                  <div class="container mt-5">
                        <div class="card" style="width: 22rem;">
                              <img src=<?= $imgDataEncoded ?> class="card-img-top" alt="...">
                              <div class="card-body">
                              ...
                              <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">Section: Section <?= $student['section'] ?></li>
                                    <br><br>
                              ...
                              <div class="card-body">
                                    <a href="<?= url('admin/students') ?>" class="card-link">Go Back</a>
                              </div>
                        </div>
                  </div>
